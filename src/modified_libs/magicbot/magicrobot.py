...
from modified_libs.robotpy_ext.autonomous import AutonomousModeSelector
from modified_libs.robotpy_ext.misc import NotifierDelay
from modified_libs.robotpy_ext.misc.simple_watchdog import SimpleWatchdog
